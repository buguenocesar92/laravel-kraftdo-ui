...
@once
    <style>
        ...
        .muni-dz:hover, .muni-dz--over { border-color:var(--kd-accent); background:var(--kd-accent-soft); }
        .muni-dz__icon { display:inline-flex; color:var(--kd-accent); }
        .muni-dz__label { font-size:13px; font-weight:600; color:var(--kd-text); }
        .muni-dz__hint { font-size:11.5px; color:var(--kd-hint); }
        .muni-dz__file { display:inline-flex; align-items:center; gap:10px; padding:6px 12px; margin-top:4px; border-radius:999px; background:var(--kd-surface); border:1px solid var(--kd-border); font-size:12.5px; font-weight:500; color:var(--kd-text); }
        .muni-dz__size { font-size:11px; color:var(--kd-muted); }
