...
@once
    <style>
        .muni-gob-bar { width:100%; background:var(--kd-gob-petroleo-dark); color:#e8f1f2; font-family:var(--kd-font-sans); }
        ...
        .muni-gob-bar__back { font-size:11.5px; font-weight:600; color:#e8f1f2; text-decoration:none; opacity:.8; transition:opacity var(--kd-dur) var(--kd-ease); white-space:nowrap; }
