...
@once
    <style>
        .muni-gob-footer { background:var(--kd-gob-petroleo-dark); color:#d9e6e8; font-family:var(--kd-font-sans); }
        ...
        .muni-gob-footer__col h4 { font-family:var(--kd-font-mono); font-size:11px; font-weight:700; letter-spacing:.08em; text-transform:uppercase; color:var(--kd-gob-lima); margin:0 0 10px; }
