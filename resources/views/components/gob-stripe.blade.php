    ...
    <style>
        .muni-gob-stripe {
            ...
            background: linear-gradient(90deg,
                var(--kd-gob-lima)    0 14.28%,
                var(--kd-gob-petroleo) 14.28% 28.57%,
                var(--kd-gob-oro)      28.57% 42.85%,
                var(--kd-gob-naranja)  42.85% 57.14%,
                var(--kd-gob-celeste)  57.14% 71.42%,
                var(--kd-gob-carmin)   71.42% 85.71%,
                var(--kd-gob-gris)     85.71% 100%
            );
        }
    </style>
@endonce
