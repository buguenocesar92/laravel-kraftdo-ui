...
<div {{ $attributes->merge(['style' => 'display:flex;align-items:flex-end;justify-content:space-between;gap:16px;flex-wrap:wrap;margin-bottom:20px;']) }}>
    <div style="min-width:0;">
        @if ($eyebrow)
            <div style="font-family:var(--kd-font-mono);font-size:11px;font-weight:600;letter-spacing:.08em;text-transform:uppercase;color:var(--kd-accent);margin-bottom:6px;">{{ $eyebrow }}</div>
        @endif
