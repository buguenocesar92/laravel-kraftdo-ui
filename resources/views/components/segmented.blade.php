...
@once
    <style>
        ...
        .muni-seg:hover { color:var(--kd-text); }
        .muni-seg:has(input:focus-visible) { box-shadow:var(--kd-ring); }
        .muni-seg--on { background:var(--kd-surface);color:var(--kd-text);box-shadow:var(--kd-shadow); }
    </style>
@endonce
