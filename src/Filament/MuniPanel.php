 ...
 *   - el tema municipal (kraftdo-ui-filament.css, sidebar oscuro y acentos),
 ...
 *
 * El escudo y el CSS se sirven desde public/vendor/kraftdo-ui/ (publicar con
 * `php artisan vendor:publish --tag=kraftdo-ui-images --tag=kraftdo-ui-filament`).
 */
        ...
        $panel
            ...
            ->renderHook(
                ...
                fn (): string => '<div class="mg-sidebar-foot">'
                    .'<img src="'.self::asset('vendor/kraftdo-ui/logo-graneros.png').'" alt="Escudo de Graneros">'
